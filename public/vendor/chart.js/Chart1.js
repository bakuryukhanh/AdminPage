                    ...
                    module.exports = function (Chart) {
                        Chart.controllers.bar = Chart.DatasetController.extend({
                            ...
                            removeHoverStyle: function (rectangle) {
                                ...
                                var custom = rectangle.custom || {};
                                var model = rectangle._model;
                                var rectangleElementOptions = this.chart.options
                                    .elements.rectangle;
                        ...
                        Chart.controllers.line = Chart.DatasetController.extend(
                            {
                                ...
                                removeHoverStyle: function (point) {
                                    ...
                                    model.borderColor = me.getPointBorderColor(
                                        point,
                                        index
                                    );
                                    model.borderWidth = me.getPointBorderWidth(
                                        point,
                                        index
                                    );
                                },
                        ...
                        Chart.controllers.radar = Chart.DatasetController.extend(
                            {
                                ...
                                removeHoverStyle: function (point) {
                                    ...
                                    var index = point._index;
                                    var model = point._model;
                                    var pointElementOptions = this.chart.options
                                        .elements.point;
                        ...
                        helpers.extend(
                            ...
                            /** @lends Chart */ {
                                ...
                                stop: function () {
                                    ...
                                    Chart.animationService.cancelAnimation(
                                        this
                                    );
                                    return this;
                                },
                                    ...
                                    merger: function (
                                        ...
                                        if (key === "scales") {
                                            ...
                                            target[key] = helpers.merge(tval, [
                                                Chart.scaleService.getScaleDefaults(
                                                    sval.type
                                                ),
                                                sval,
                                            ]);
                    ...
                    module.exports = function (Chart) {
                        ...
                        Chart.Scale = Element.extend({
                            ...
                            mergeTicksOptions: function () {
                                ...
                                for (var key in ticks) {
                                    if (key !== "major" && key !== "minor") {
                                        if (
                                            typeof ticks.minor[key] ===
                                            "undefined"
                                        ) {
                                            ticks.minor[key] = ticks[key];
                                        }
                                        if (
                                            typeof ticks.major[key] ===
                                            "undefined"
                                        ) {
                            ...
                            update: function (maxWidth, maxHeight, margins) {
                                ...
                                labels =
                                    me.convertTicksToLabels(ticks) || me.ticks;
                            ...
                            getPixelForTick: function (index) {
                                ...
                                return (
                                    me.top +
                                    index *
                                        (innerHeight / (me._ticks.length - 1))
                                );
                            },
                            ...
                            draw: function (chartArea) {
                                ...
                                var scaleLabelFont = parseFontOptions(
                                    scaleLabel
                                );
                                var scaleLabelPadding = helpers.options.toPadding(
                                    scaleLabel.padding
                    ...
                    module.exports = function (Chart) {
                        Chart.scaleService = {
                            ...
                            registerScaleType: function (
                                ...
                                this.defaults[type] = helpers.clone(
                                    scaleDefaults
                                );
                            },
                    ...
                    module.exports = function (Chart) {
                        ...
                        Chart.Tooltip = Element.extend({
                            ...
                            getTitle: function () {
                                ...
                                var title = callbacks.title.apply(
                                    me,
                                    arguments
                                );
                            ...
                            getFooter: function () {
                                ...
                                var footer = callbacks.footer.apply(
                                    me,
                                    arguments
                                );
                    ...
                    module.exports = function (Chart) {
                        ...
                        Chart.LinearScaleBase = Chart.Scale.extend({
                            getRightValue: function (value) {
                                ...
                                return Chart.Scale.prototype.getRightValue.call(
                                    this,
                                    value
                                );
                            },
                            ...
                            convertTicksToLabels: function () {
                                ...
                                Chart.Scale.prototype.convertTicksToLabels.call(
                                    me
                                );
                            },
                        });
                    ...
                    module.exports = function (Chart) {
                        ...
                        var TimeScale = Chart.Scale.extend({
                            ...
                            update: function () {
                                ...
                                return Chart.Scale.prototype.update.apply(
                                    me,
                                    arguments
                                );
                            },
